...
// 액션 생성 함수 정의
export const changeShopInfo = (shopInfo: ShopInfo) => ({
	type: SHOP_INFO,
	shopInfo,
});

type shopAction = ReturnType<typeof changeShopInfo>;
...
const initialState = {
	info: {
		shopId: 1,
		businessNumber: "17-123-1234",
		businessName: "동찬이네",
		businessPhone: ["02", "123", "1234"],
		dayOff: [false, false, false, true, false, false, true],
